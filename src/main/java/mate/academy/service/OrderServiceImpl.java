...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        ...
        logger.info("CompleteOrder method was called by user with id: {}", userId);
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("Retrieved {} products from shopping cart for user ID: {}",
                products.size(), userId);
        logger.debug("Products list: {}", products);
        return products;
    }
}
